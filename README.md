...
- Voltage of each phase (Va, Vb, Vc)
- Current draw of each phase (Ia, Ib, Ic)
...
For the full data set, visit [IEEE Broken Rotor Bar Database](https://dx.doi.org/10.21227/fmnm-bn95), download the entire repository as a ZIP file, and save it in the same directory as this Live Script.
